...
app.get('/games', (req, res) => {
 ...
 getGames.then((list) => {
  ...
  app.post('/games', function (req, res) {
    let game = req.body;
    console.log(game) // STILL NOT BEING DEFINED HERE
    axios.post('http://localhost:8080/api/v1/media/GAME/add', {headers: {'Content-Type':'application/json'}}, game)
    .then(res => {
  ...
  app.get('/delete', function (req, res) {
    axios.delete('http://localhost:8080/api/v1/media/GAME/5eb00d3945f6bc46887d8a75').then(res => {
